  ...
  return (
    <div className="min-h-screen bg-[#060912] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col items-center justify-center p-12">
        <div className="absolute inset-0 bg-gradient-to-br from-violet-900/60 via-[#060912] to-blue-900/40" />
        ...
        <div className="relative z-10 text-center max-w-sm">
          ...
          <p className="text-gray-400 text-base leading-relaxed mb-10">
            Masuk dan kelola semua link bio kamu dalam satu dashboard yang canggih.
          </p>

          {/* Feature highlights */}
          <div className="space-y-3 text-left">
            {[
              { icon: '📊', text: 'Analytics klik real-time' },
              { icon: '🎨', text: 'Custom theme & gradient' },
              { icon: '📱', text: 'QR Code generator' },
              { icon: '⏰', text: 'Link scheduling otomatis' },
            ].map((item, i) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-black text-white tracking-tight">Masuk ke Akun</h1>
            <p className="text-gray-500 mt-2">Belum punya akun?{' '}
